# Roomba - simulating robots
# This program was created as a part of the MITx 6002 course
...
class Robot(object):
    ...
    def __init__(self, room, speed):
        ...
        self.room = room
        self.speed = speed
        self.direction = random.uniform(1,360)
        self.position = Position(random.uniform(0,room.width), \
...
showPlot1('Time It Takes To Clean 80 Percent Of a Room', 'Number of Robots', 'Time Steps')
showPlot2('Two Robots To Clean 80 Percent Of Variously Shaped Rooms', 'Aspect Ratio', 'Time Steps')
